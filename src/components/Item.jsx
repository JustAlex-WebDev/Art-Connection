    ...
    >
      <div className="image relative w-[10rem] md:w-[11.5rem] lg:w-[13rem]">
        <img
          src={item.img}
          alt="painting"
          className="w-[10rem] md:w-[11.5rem] lg:w-[13rem] object-scale-down h-[13rem] shadow-xl bg-[#fcf0e2]"
        />
        <div className="overlay absolute hidden justify-center items-center w-[10rem] md:w-[11.5rem] lg:w-[13rem] h-[13rem] top-0 hover:backdrop-brightness-75 hover:backdrop-blur-sm ease-in-out duration-100">
          <button className="bg-[#f7f7ec] text-[#543232] px-2 md:px-8 py-2 mx-2 rounded-2xl shadow-lg hover:scale-105 duration-100 ease-in-out">
      ...
      <div className="flex w-[7rem] md:w-[10rem] lg:w-[13rem] justify-start flex-col relative">
        <h3>{item.name}</h3>
        <h3 className="opacity-60">{item.author}</h3>
        <h3 className="pt-4">{item.price.toLocaleString()} USD</h3>
        <div className="flex text-[#543232] justify-end ml-32 md:ml-36 lg:ml-40 absolute">
