...
interface SortProps {
  ...
  sortedHighLow: boolean;
  setSortedHighLow: React.Dispatch<React.SetStateAction<boolean>>;
  sortedLowHigh: boolean;
  setSortedLowHigh: React.Dispatch<React.SetStateAction<boolean>>;
  sortedNone: boolean;
  setSortedNone: React.Dispatch<React.SetStateAction<boolean>>;
